...
@objc extension StatusAlert {
    ...
    public final class Appearance: NSObject {
        ...
        ///
        /// - Note: Do not change to save system look
        @objc public var backgroundColor: UIColor = UIColor.systemGroupedBackground
    ...
    public final class SizesAndDistances: NSObject {
        ...
        @objc public var alertWidth: CGFloat = 168
        @objc public var minimumAlertHeight: CGFloat = 168
        
        @objc public var minimumStackViewTopSpace: CGFloat = 24
        @objc public var minimumStackViewBottomSpace: CGFloat = 24
        @objc public var stackViewSideSpace: CGFloat = 24
        
        @objc public var imageBottomSpace: CGFloat = 16
        @objc public var titleBottomSpace: CGFloat = 5
        @objc public var imageToMessageSpace: CGFloat = 8
